...
def getHoraxIntervalo(numero):
    ...
    # Calcular la hora base y el índice de minutos
    base_hora = 6
    intervalos_por_hora = 4  # Hay 4 intervalos de 15 minutos en una hora
    minutos_por_intervalo = 15
    
    # Convertir el número a un índice de intervalo (0 basado)
    intervalo = numero - 1
    
    # Calcular la hora y los minutos
...
# Función para llenar los datos en el rango correspondiente
...
def main():
    ...
    print(roles_colores["Cajer@"])
    #Nombre
    print(Salidas[69][0][0])
    #Cargo
    print(Salidas[69][0][1])
    #Nombre y Cargo
    print(Salidas[69][0])
    #Todos los que Salen a las 69
    print(Salidas[69])
...
# Crear matrices tridimensionales de 73 filas, 6 columnas y 2 cadenas, inicialmente llenas de listas vacías
...
# Insertar un valor en la siguiente posición vacía de la fila 1 en Entradas
#Empilar(Entradas, getNHora("6:00"), "Renan", "RS")

# Mostrar la fila 1 para ver el cambio
#print(Entradas[1])  # Verás que "Renan" está en la siguiente posición vacía de la fila 1



#Para Cada Tipo de Personal Hacer:
