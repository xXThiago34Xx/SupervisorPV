...
def crearHojaXDia(wb, Entradas, Salidas, dia):
    ...
    #Izquierda
    rellenar(ws, "B1", "Caj@s", roles_colores["Cajer@"])
    rellenar(ws, "C1", "RS", roles_colores["RS"])
    rellenar(ws, "D1", "Self", roles_colores["Self Checkout"])
    rellenar(ws, "E1", "RT", roles_colores["Ecommerce"])
    rellenar(ws, "F1", "Supers", roles_colores["Supervisor(@)"])

    #Derecha
    rellenar(ws, "J1", "Caj@s", roles_colores["Cajer@"])
    rellenar(ws, "K1", "RS", roles_colores["RS"])
    rellenar(ws, "L1", "Self", roles_colores["Self Checkout"])
    rellenar(ws, "M1", "RT", roles_colores["Ecommerce"])
    rellenar(ws, "N1", "Supers", roles_colores["Supervisor(@)"])
    ...
    diaM = dia.capitalize()
    combinar_y_centrar_celdas(ws, "A2", "G2", f"Horas de Entrada del Personal del Area de Cajas del Día {diaM}")
    combinar_y_centrar_celdas(ws, "H2", "O2", f"Horas de Salida del Personal del Area de Cajas  Día {diaM}")
