...
def registrar_horario_por_categoria(categoria, personal):
    ...
    if not  personal_categoria:
        ...
        return
    reiniciar = registrar_horario(personal_categoria)
    if reiniciar == "reiniciar_semana":
        return registrar_horario_por_categoria(categoria, personal)
...
def mostrar_menu():
    while True:
        ...
        print("3. Cajer@")
        print("4. Ecommerce")
        print("5. Registrar manualmente por apellido")
        ...
        if opcion == "1":
            ...
            confirmar = input("¿Está seguro de que desea limpiar el archivo de horarios? Esto borrará todos los datos. (s/n): ")
            if confirmar.lower() == "s":
                limpiar_archivo("horario.txt")
                print("El archivo de horarios ha sido limpiado.")
        elif opcion == "0":
...
# Cargar personal desde un archivo de texto
